...
2. Run this command:  `rails _6.0.2_ new shipit --skip-action-cable --skip-turbolinks --skip-action-mailer --skip-active-storage -m https://raw.githubusercontent.com/Shopify/shipit-engine/master/template.rb`
