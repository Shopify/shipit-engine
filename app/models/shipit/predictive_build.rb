...
module Shipit
  class PredictiveBuild < Record
    ...
    WIP_STATUSES = %w(pending ci_stack_tasks ci_pipeline_run ci_pipeline_running ci_pipeline_verification ci_pipeline_verifying ci_pipeline_verified ci_pipeline_canceling).freeze
