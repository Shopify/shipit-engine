...
if Gem::Version.new(RUBY_VERSION) < Gem::Version.new('2.5')
  raise Thor::Error, "You need at least Ruby 2.5 to install shipit"
end
if Gem::Version.new(Rails::VERSION::STRING) < Gem::Version.new('6.0')
  raise Thor::Error, "You need Rails 6.0 to install shipit"
end
...
inject_into_file 'config/application.rb', after: "load_defaults 6.0\n" do
